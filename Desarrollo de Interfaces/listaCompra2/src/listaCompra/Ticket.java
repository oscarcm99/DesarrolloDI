...
public class Ticket {
	...
	private void initialize() {
		...
		frmListaDeLa.getContentPane().setBackground(Color.CYAN);
		...
		btnNewButton_1.setBounds(468, 217, 142, 25);
		frmListaDeLa.getContentPane().add(btnNewButton_1);
		
		JButton btnNewButton_2 = new JButton("Log out");
		btnNewButton_2.setBounds(468, 268, 142, 25);
		frmListaDeLa.getContentPane().add(btnNewButton_2);
		
		JList list = new JList();
		list.setBounds(68, 161, 236, 209);
		frmListaDeLa.getContentPane().add(list);
		
		JButton btnNewButton_3 = new JButton("Eliminar producto");
		btnNewButton_3.setBounds(468, 317, 142, 25);
		frmListaDeLa.getContentPane().add(btnNewButton_3);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lista.addElement(textField_2.getText()+" "+(cantidad*precioUnidad)+"€");
				list.setModel(lista);
				//list.add(textField_2.getText()+" "+(cantidad*precioUnidad)+"€");//append(textField_2.getText()+" "+(cantidad*precioUnidad)+"€"+"\n");
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lista.removeElementAt(list.getSelectedIndex());
				list.setModel(lista);
			}
		});
	}
